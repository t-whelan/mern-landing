      ...
      <div className="about-content">
        ...
        <div className="prerequisites-container">
          ...
          <ul className='text-lg font-sans'> 
            <li><span className="check-icon">&#10003;</span> Eagerness to learn and grow</li>
            <li><span className="check-icon">&#10003;</span> Self-discipline and motivation</li>
            <li><span className="check-icon">&#10003;</span> A reliable laptop and internet connection</li>
            <li><span className="check-icon">&#10003;</span> Basic programming knowledge in HTML and CSS</li>
            <li><span className="check-icon">&#10003;</span> Foundational knowledge of JavaScript</li>
            <li><span className="check-icon">&#10003;</span> Familiarity with version control systems like Git is a plus</li>
          </ul>
        </div>
      </div>
